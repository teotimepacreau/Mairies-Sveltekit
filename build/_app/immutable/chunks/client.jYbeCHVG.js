...
`)}`);return{data:f==null?void 0:f.data,errors:(f==null?void 0:f.errors)||null,query:o.query}}}function re(s){return new te(s)}function P(s,...h){let o="";return s.forEach((g,y)=>{o+=g+(h[y]||"")}),o}const S=P`
  ...
  pagesConnection(
    ...
    ${C}`;function ae(s){return{article(h,o){return s(ne,h,o)},articleConnection(h,o){return s(oe,h,o)},pages(h,o){return s(se,h,o)},pagesConnection(h,o){return s(ie,h,o)}}}const fe=(s,h)=>async(g,y,d)=>{let v=s.apiUrl;if(d!=null&&d.branch){const f=s.apiUrl.lastIndexOf("/");v=s.apiUrl.substring(0,f+1)+d.branch}const l=await s.request({query:g,variables:y,url:v});return{data:l==null?void 0:l.data,errors:l==null?void 0:l.errors,query:g,variables:y||{}}},ue=(s,h)=>{const o=fe(s);return ae(o)},le=re({url:"https://content.tinajs.io/1.4/content/b0376671-e258-4c36-8fa7-4ca68387c7a8/github/tina",token:"600ef325207364bc7ac69d039b6b05fa97b8c8e1",queries:ue});export{le as c};
